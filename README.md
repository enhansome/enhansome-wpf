...
Inspired by [awesome](https://github.com/sindresorhus/awesome) ⭐ 503,873 | 🐛 106 | 📅 2026-09-02, [awesome-dotnet](https://github.com/quozd/awesome-dotnet) ⭐ 21,587 | 🐛 147 | 📅 2026-03-26, [awesome-dotnet-core](https://github.com/thangchung/awesome-dotnet-core) ⭐ 21,372 | 🐛 213 | 🌐 C# | 📅 2026-02-27.
...
* [Windows Presentation Foundation (WPF) | GitHub](https://github.com/dotnet/wpf) ⭐ 7,726 | 🐛 1,668 | 🌐 C# | 📅 2026-09-07 - Windows Presentation Foundation GitHub Repository | WPF is a .NET Core UI framework for building Windows desktop applications.
* [WPF-Samples](https://github.com/microsoft/WPF-Samples) ⭐ 5,730 | 🐛 80 | 🌐 C# | 📅 2026-08-19 - Microsoft Repository for WPF related samples.
...
* [Material Design In XAML Toolkit](https://github.com/MaterialDesignInXAML/MaterialDesignInXamlToolkit) ⭐ 16,252 | 🐛 144 | 🌐 C# | 📅 2026-09-04 - (FREE, OPEN SOURCE) Google's Material Design in XAML & WPF, for C# & VB.Net.
...
* [HandyControl](https://github.com/handyOrg/HandyControl) ⭐ 7,180 | 🐛 329 | 🌐 C# | 📅 2026-08-11 - (FREE, OPEN SOURCE) Contains some simple and commonly used WPF controls.
* [ModernWPF UI Library](https://github.com/Kinnara/ModernWpf) ⭐ 4,961 | 🐛 2 | 🌐 C# | 📅 2026-09-07 - (FREE, OPEN SOURCE) Modern styles and controls for your WPF applications.
...
* [ControlzEx](https://github.com/ControlzEx/ControlzEx) ⭐ 1,068 | 🐛 9 | 🌐 C# | 📅 2026-08-21 - (FREE, OPEN SOURCE) Shared Controlz for WPF.
* [UI.WPF.Modern](https://github.com/iNKORE-NET/UI.WPF.Modern) ⭐ 1,031 | 🐛 93 | 🌐 C# | 📅 2026-07-26 - (FREE, OPEN SOURCE) An innovative UI library for Windows Presentation Foundation (WPF) applications, designed to emulate the sleek and modern aesthetics of the Fluent Design system found in WinUI.
...
* [mpv.net](https://github.com/stax76/mpv.net) ⭐ 5,379 | 🐛 156 | 🌐 C# | 📅 2026-02-09 - (FREE, OPEN SOURCE) mpv.net is a modern media player for Windows that works just like mpv.
* [Fluent.Ribbon](https://github.com/fluentribbon/Fluent.Ribbon) ⭐ 2,758 | 🐛 14 | 🌐 C# | 📅 2026-08-23 - (FREE, OPEN SOURCE) Fluent.Ribbon is a library that implements an Office-like user interface for the Windows Presentation Foundation (WPF).
...
* [AvalonEdit](https://github.com/icsharpcode/AvalonEdit) ⭐ 2,079 | 🐛 117 | 🌐 C# | 📅 2025-12-04 - (FREE, OPEN SOURCE) AvalonEdit is the name of the WPF-based text editor in SharpDevelop 4.x.
* [PropertyTools](https://github.com/PropertyTools/PropertyTools) ⭐ 1,324 | 🐛 58 | 🌐 C# | 📅 2026-08-08 - (FREE, OPEN SOURCE) Custom controls for WPF: PropertyGrid, DataGrid, multi-select TreeView, ColorPicker and more.
...
* [Xaml-Math](https://github.com/ForNeVeR/xaml-math) ⭐ 719 | 🐛 94 | 🌐 C# | 📅 2026-09-02 - (FREE, OPEN SOURCE) XAML-Math is a collection of .NET libraries for rendering mathematical formulae using the LaTeX typesetting style, for the WPF and Avalonia XAML-based frameworks.
...
* [FontAwesome.Sharp](https://github.com/awesome-inc/FontAwesome.Sharp) ⭐ 424 | 🐛 0 | 🌐 C# | 📅 2025-05-31 - (FREE, OPEN SOURCE) A library for embedding Font Awesome icons in WPF & Windows Forms applications via NuGet. Inspired by ioachim/fontawesome.wpf (Bitbucket) and Using Font Icons (CodeProject).
...
* [Material Design In XAML Toolkit](https://github.com/MaterialDesignInXAML/MaterialDesignInXamlToolkit) ⭐ 16,252 | 🐛 144 | 🌐 C# | 📅 2026-09-04 - (FREE, OPEN SOURCE) Material Design UI libraries, styles and additional controls.
* [ModernWPF UI Library](https://github.com/Kinnara/ModernWpf) ⭐ 4,961 | 🐛 2 | 🌐 C# | 📅 2026-09-07 - (FREE, OPEN SOURCE) Modern styles and controls for your WPF applications.
...
* [Prism](https://github.com/PrismLibrary/Prism) ⭐ 6,842 | 🐛 28 | 🌐 C# | 📅 2026-08-06 - (FREE, OPEN SOURCE) Prism is a framework for building loosely coupled, maintainable, and testable XAML applications in WPF, and Xamarin Forms.
