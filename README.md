...
Inspired by [awesome](https://github.com/sindresorhus/awesome) ⭐ 504,700 | 🐛 106 | 📅 2026-09-02, [awesome-dotnet](https://github.com/quozd/awesome-dotnet) ⭐ 21,592 | 🐛 150 | 📅 2026-03-26, [awesome-dotnet-core](https://github.com/thangchung/awesome-dotnet-core) ⭐ 21,372 | 🐛 213 | 🌐 C# | 📅 2026-02-27.
...
* [Windows Presentation Foundation (WPF) | GitHub](https://github.com/dotnet/wpf) ⭐ 7,724 | 🐛 1,672 | 🌐 C# | 📅 2026-09-10 - Windows Presentation Foundation GitHub Repository | WPF is a .NET Core UI framework for building Windows desktop applications.
* [WPF-Samples](https://github.com/microsoft/WPF-Samples) ⭐ 5,729 | 🐛 80 | 🌐 C# | 📅 2026-08-19 - Microsoft Repository for WPF related samples.
...
* [Material Design In XAML Toolkit](https://github.com/MaterialDesignInXAML/MaterialDesignInXamlToolkit) ⭐ 16,254 | 🐛 147 | 🌐 C# | 📅 2026-09-04 - (FREE, OPEN SOURCE) Google's Material Design in XAML & WPF, for C# & VB.Net.
...
* [HandyControl](https://github.com/handyOrg/HandyControl) ⭐ 7,182 | 🐛 329 | 🌐 C# | 📅 2026-08-11 - (FREE, OPEN SOURCE) Contains some simple and commonly used WPF controls.
* [ModernWPF UI Library](https://github.com/Kinnara/ModernWpf) ⭐ 4,957 | 🐛 2 | 🌐 C# | 📅 2026-09-07 - (FREE, OPEN SOURCE) Modern styles and controls for your WPF applications.
* [Extended WPF Toolkit](https://github.com/xceedsoftware/wpftoolkit) ⭐ 4,167 | 🐛 783 | 🌐 C# | 📅 2026-06-11 - (FREE FOR NON COMMERCIAL USE, OPEN SOURCE) WPF controls, components and utilities for creating next generation Windows applications.
...
* [Adonis-UI](https://github.com/benruehl/adonis-ui) ⭐ 1,868 | 🐛 50 | 🌐 C# | 📅 2022-09-29 - (FREE, OPEN SOURCE) Lightweight UI toolkit for WPF applications offering classic but enhanced windows visuals.
...
* [ControlzEx](https://github.com/ControlzEx/ControlzEx) ⭐ 1,067 | 🐛 9 | 🌐 C# | 📅 2026-08-21 - (FREE, OPEN SOURCE) Shared Controlz for WPF.
* [UI.WPF.Modern](https://github.com/iNKORE-NET/UI.WPF.Modern) ⭐ 1,028 | 🐛 94 | 🌐 C# | 📅 2026-07-26 - (FREE, OPEN SOURCE) An innovative UI library for Windows Presentation Foundation (WPF) applications, designed to emulate the sleek and modern aesthetics of the Fluent Design system found in WinUI.
...
* [MosaicUIWpf](https://github.com/blakepell/MosaicUIWpf) ⭐ 18 | 🐛 0 | 🌐 C# | 📅 2026-09-05 - (FREE, OPEN SOURCE) Mosaic UI for WPF is a control library that seeks to provide compartmentalized controls.
...
* [CefSharp](https://github.com/cefsharp/cefsharp) ⭐ 10,254 | 🐛 71 | 🌐 C# | 📅 2026-09-04 - (FREE, OPEN SOURCE) .NET (WPF and Windows Forms) bindings for the Chromium Embedded Framework.
* [mpv.net](https://github.com/stax76/mpv.net) ⭐ 5,382 | 🐛 156 | 🌐 C# | 📅 2026-02-09 - (FREE, OPEN SOURCE) mpv.net is a modern media player for Windows that works just like mpv.
* [Fluent.Ribbon](https://github.com/fluentribbon/Fluent.Ribbon) ⭐ 2,757 | 🐛 15 | 🌐 C# | 📅 2026-08-23 - (FREE, OPEN SOURCE) Fluent.Ribbon is a library that implements an Office-like user interface for the Windows Presentation Foundation (WPF).
...
* [AvalonEdit](https://github.com/icsharpcode/AvalonEdit) ⭐ 2,081 | 🐛 117 | 🌐 C# | 📅 2025-12-04 - (FREE, OPEN SOURCE) AvalonEdit is the name of the WPF-based text editor in SharpDevelop 4.x.
* [PropertyTools](https://github.com/PropertyTools/PropertyTools) ⭐ 1,323 | 🐛 58 | 🌐 C# | 📅 2026-08-08 - (FREE, OPEN SOURCE) Custom controls for WPF: PropertyGrid, DataGrid, multi-select TreeView, ColorPicker and more.
...
* [WpfHexEditorControl](https://github.com/abbaye/WpfHexEditorControl) ⭐ 933 | 🐛 15 | 🌐 C# | 📅 2026-06-29 - (FREE, OPEN SOURCE) Wpf Hexeditor is a fast and fully customisable user control for editing file or stream as hexadecimal. Can be used in Wpf or WinForm application.
...
* [Xaml-Math](https://github.com/ForNeVeR/xaml-math) ⭐ 719 | 🐛 93 | 🌐 C# | 📅 2026-09-10 - (FREE, OPEN SOURCE) XAML-Math is a collection of .NET libraries for rendering mathematical formulae using the LaTeX typesetting style, for the WPF and Avalonia XAML-based frameworks.
* [Notifications.Wpf](https://github.com/Federerer/Notifications.Wpf) ⭐ 718 | 🐛 17 | 🌐 C# | 📅 2021-10-20 - (FREE, OPEN SOURCE) WPF toast notifications.
* [Emoji.Wpf](https://github.com/samhocevar/emoji.wpf) ⭐ 422 | 🐛 34 | 🌐 C# | 📅 2024-05-21 - (FREE, OPEN SOURCE) Emoji.Wpf is an implementation of color Emoji rendering for WPF.
...
* [WPFCustomMessageBox](https://github.com/evanwon/WPFCustomMessageBox) ⭐ 133 | 🐛 14 | 🌐 C# | 📅 2022-12-29 - (FREE, OPEN SOURCE) WPFCustomMessageBox is a WPF clone of the native Windows/.NET MessageBox with extra features like custom button text.
...
* [Material Design In XAML Toolkit](https://github.com/MaterialDesignInXAML/MaterialDesignInXamlToolkit) ⭐ 16,254 | 🐛 147 | 🌐 C# | 📅 2026-09-04 - (FREE, OPEN SOURCE) Material Design UI libraries, styles and additional controls.
* [ModernWPF UI Library](https://github.com/Kinnara/ModernWpf) ⭐ 4,957 | 🐛 2 | 🌐 C# | 📅 2026-09-07 - (FREE, OPEN SOURCE) Modern styles and controls for your WPF applications.
...
* [Prism](https://github.com/PrismLibrary/Prism) ⭐ 6,841 | 🐛 25 | 🌐 C# | 📅 2026-09-09 - (FREE, OPEN SOURCE) Prism is a framework for building loosely coupled, maintainable, and testable XAML applications in WPF, and Xamarin Forms.
* [MvvmCross](https://github.com/MvvmCross/MvvmCross) ⭐ 3,922 | 🐛 184 | 🌐 C# | 📅 2026-09-03 - (FREE, OPEN SOURCE) The .NET MVVM framework for cross-platform solutions, including Xamarin.iOS, Xamarin.Android, Windows and Mac.
...
* [GongSolutions.WPF.DragDrop](https://github.com/punker76/gong-wpf-dragdrop) ⭐ 2,566 | 🐛 45 | 🌐 C# | 📅 2025-12-01 - (FREE, OPEN SOURCE) An easy to use drag'n'drop framework for WPF.
* [FluentWPF](https://github.com/sourcechord/FluentWPF) ⭐ 1,533 | 🐛 40 | 🌐 C# | 📅 2022-04-08 - (FREE, OPEN SOURCE) Fluent Design System for WPF.
...
* [Elmish.WPF](https://github.com/elmish/Elmish.WPF) ⭐ 462 | 🐛 61 | 🌐 F# | 📅 2024-10-01 - (FREE, OPEN SOURCE) The good parts of MVVM (the data bindings) with the simplicity and robustness of an MVU architecture for the rest of your app. Never write a ViewModel class again!
...
* [Snoop](https://github.com/snoopwpf/snoopwpf) ⭐ 2,530 | 🐛 17 | 🌐 C# | 📅 2026-08-23 - (FREE, OPEN SOURCE) Snoop is the open source WPF spying utility. It allows you to spy/browse the visual tree of a running application.
