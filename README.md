...
Inspired by [awesome](https://github.com/sindresorhus/awesome) ⭐ 503,157 | 🐛 106 | 📅 2026-09-02, [awesome-dotnet](https://github.com/quozd/awesome-dotnet) ⭐ 21,583 | 🐛 147 | 📅 2026-03-26, [awesome-dotnet-core](https://github.com/thangchung/awesome-dotnet-core) ⭐ 21,371 | 🐛 213 | 🌐 C# | 📅 2026-02-27.
...
* [Windows Presentation Foundation (WPF) | GitHub](https://github.com/dotnet/wpf) ⭐ 7,725 | 🐛 1,666 | 🌐 C# | 📅 2026-09-05 - Windows Presentation Foundation GitHub Repository | WPF is a .NET Core UI framework for building Windows desktop applications.
...
* [HandyControl](https://github.com/handyOrg/HandyControl) ⭐ 7,178 | 🐛 329 | 🌐 C# | 📅 2026-08-11 - (FREE, OPEN SOURCE) Contains some simple and commonly used WPF controls.
* [ModernWPF UI Library](https://github.com/Kinnara/ModernWpf) ⭐ 4,961 | 🐛 4 | 🌐 C# | 📅 2026-08-31 - (FREE, OPEN SOURCE) Modern styles and controls for your WPF applications.
...
* [MosaicUIWpf](https://github.com/blakepell/MosaicUIWpf) ⭐ 17 | 🐛 0 | 🌐 C# | 📅 2026-09-04 - (FREE, OPEN SOURCE) Mosaic UI for WPF is a control library that seeks to provide compartmentalized controls.
...
* [AvalonEdit](https://github.com/icsharpcode/AvalonEdit) ⭐ 2,078 | 🐛 117 | 🌐 C# | 📅 2025-12-04 - (FREE, OPEN SOURCE) AvalonEdit is the name of the WPF-based text editor in SharpDevelop 4.x.
...
* [ConsoleControl](https://github.com/dwmkerr/consolecontrol) ⭐ 786 | 🐛 36 | 🌐 C# | 📅 2023-05-29 - (FREE, OPEN SOURCE) ConsoleControl is a C# class library that lets you embed a console in a WinForms or WPF application.
...
* [Prism](https://github.com/PrismLibrary/Prism) ⭐ 6,840 | 🐛 27 | 🌐 C# | 📅 2026-08-06 - (FREE, OPEN SOURCE) Prism is a framework for building loosely coupled, maintainable, and testable XAML applications in WPF, and Xamarin Forms.
* [MvvmCross](https://github.com/MvvmCross/MvvmCross) ⭐ 3,923 | 🐛 184 | 🌐 C# | 📅 2026-09-03 - (FREE, OPEN SOURCE) The .NET MVVM framework for cross-platform solutions, including Xamarin.iOS, Xamarin.Android, Windows and Mac.
...
* [GongSolutions.WPF.DragDrop](https://github.com/punker76/gong-wpf-dragdrop) ⭐ 2,563 | 🐛 45 | 🌐 C# | 📅 2025-12-01 - (FREE, OPEN SOURCE) An easy to use drag'n'drop framework for WPF.
